<div class="flex h-full flex-col justify-around text-white">
	<svg
		...
		aria-hidden="true"
		aria-label=""
		class="mx-auto my-8 h-10"
		><defs
			><style>
				#comp-lvwk7n8l3 svg [data-color='1'] {
					fill: #ffffff;
				}
			</style></defs
		>
	...
	<div class="mx-auto max-w-7xl text-2xl font-thin">
		<slot />
	</div>
	<div class="mx-auto my-8 inline-flex text-center text-xl">
		—
		<slot name="author" />
	</div>
</div>
